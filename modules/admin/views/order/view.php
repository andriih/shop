    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <th>Ціна</th>
                <th>Сумма</th>
                <th><span class="glyphicon glyphicon-remove" aria-heidden="true"></span></th>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($items as $item): ?>
                <tr>
                    ...
                    <td><?= $item['price'] ?></td>
                    <td><?= $item['sum_item'] ?></td>
                    <td><span data-id="<?=$id;?>" class="glyphicon glyphicon-remove text-danger del-item" aria-heidden="true"></span></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
